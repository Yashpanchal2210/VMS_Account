...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <form id="leadPoisioningForm" runat="server">
            ...
            <div>
                <asp:GridView ID="GridViewExtraIssueCategory2" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" OnRowDeleting="GridViewExtraIssueLead_RowDeleting" DataKeyNames="Id">
                    <Columns>
